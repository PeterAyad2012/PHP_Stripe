...
class Config
{
    ...
    const WORK_ROOT = '/Stripe/';

    const HOME_URL = Config::APP_ROOT . Config::WORK_ROOT;

    /* Stripe API test keys */
    const STRIPE_PUBLISHIABLE_KEY = "pk_test_51MwPT7Ad356F9iRGFcurypg7UtYbknA6yIEwHKMUZrgmcQv129HDewQ0iy4E63F3Z0cSzBPbjvqb3m4ySpkoiqPF00m70hCTxh";

    const STRIPE_SECRET_KEY = "sk_test_51MwPT7Ad356F9iRGFTeKZU2H3uvo9ZV47Ml0w7aMt82dCnbLmFebxM6Bllzqn3WOZiDzCZzsxETCXSAkwdKEbVL000WODmUYrW";
